...
class _StatsScreenState extends State<StatsScreen> {
  ...
  Future<void> _trainSingleModel({
    ...
    try {
      ...
      switch (difficulty) {
        case 'easy':
          // Easy: utilise que les 3 dernières parties (apprentissage limité)
          trainingGames = recentGames.length > 3
              ? recentGames.sublist(recentGames.length - 3)
              : recentGames;
          break;
        case 'medium':
          // Medium: utilise les 5 dernières parties
          trainingGames = recentGames.length > 5
              ? recentGames.sublist(recentGames.length - 5)
              : recentGames;
          break;
        case 'hard':
          // Hard: utilise les 8 dernières parties
          trainingGames = recentGames.length > 8
              ? recentGames.sublist(recentGames.length - 8)
              : recentGames;
          break;
        case 'expert':
