    ...
    try {
      ...
      for (int i = 0; i < _gameCount; i++) {
        try {
          ...
          final board1 = gameService.randomizeShipPlacement(Board.empty());
          final board2 = gameService.randomizeShipPlacement(Board.empty());
          
          // Simuler le jeu
          final stats = await analytics.simulateGame(board1, board2);
      ...
      String message = '✅ Simulation terminée! $_gameCount parties simulées\n💾 $savedCount sauvegardées en MongoDB';
      if (failedCount > 0) {
