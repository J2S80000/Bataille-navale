...
class _PlacementScreenState extends State<PlacementScreen> {
  ...
  Future<void> _loadRecommendations() async {
    ...
    try {
      ...
      final strategies = analytics.recommendPlacementStrategy(
        myStats: allStats,
  ...
  void _placeShip(Ship ship, int row, int col) {
    try {
      final newBoard = board.placeShip(ship, row, col, isHorizontal);
      setState(() {
        board = newBoard;
        selectedShip = null;
      });
    ...
    try {
      ...
      for (final ship in ships) {
        ...
        while (!placed) {
          ...
          try {
            tempBoard = tempBoard.placeShip(ship, row, col, isHoriz);
            placed = true;
          } catch (e) {
            // Réessayer
          }
