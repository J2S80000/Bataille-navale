    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              _buildAnalysisRow('📍 Orientation', 
                placementPatterns['preferredOrientation'] ?? 'N/A'),
              _buildAnalysisRow('🎯 Zone favorite', 
                placementPatterns['favoriteZone'] ?? 'N/A'),
              _buildAnalysisRow('📊 Densité', 
                placementPatterns['clustering'] ?? 'N/A'),
              _buildAnalysisRow('🔢 Tentatives', 
                '${placementPatterns['totalPositionsAttempted'] ?? 0} positions'),
              _buildAnalysisRow('✅ Touches', 
                '${placementPatterns['totalHits'] ?? 0} hits'),
              Padding(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          placementPatterns['mostUsedPositions'] ?? 'Aucune donnée',
