...
class AIModelManager {
  ...
  static Future<NeuralNetworkAI> trainModelWithDifficulty({
    ...
    // LE COMPTEUR trainingIterations ACCUMULE LES EPOCHS TOTAUX
    int epochs = 1;
    switch (difficulty) {
      case 'easy':
        epochs = 5; // Apprentissage léger mais plus d'epochs
        break;
      case 'medium':
        epochs = 10; // Apprentissage modéré
        break;
      case 'hard':
        epochs = 15; // Apprentissage important
        break;
      case 'expert':
        epochs = 20; // Apprentissage maximal
        break;
    }

    print('[TRAIN] $difficulty: ${recentGames.length} parties, $epochs epochs');
    print('[TRAIN] Avant entraînement: ${model.trainingIterations} entraînements accumulés');
    ...
    print('[TRAIN] Après entraînement: ${model.trainingIterations} entraînements accumulés');
    return model;
  }
