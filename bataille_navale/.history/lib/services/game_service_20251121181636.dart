...
class GameService {
  ...
  (MoveResult result, Game updatedGame) processMove(
    ...
    // On utilise le board AVEC les ships (pas masqué) pour déterminer le résultat
    ...
    // On ne peut tirer que sur des cellules qui n'ont pas été attaquées
    // Les cellules "ship" sont OK (première attaque sur ce navire)
    // Les cellules "empty" sont OK (première attaque ici)
    // Les cellules "hit/miss/sunk" sont NON-OK (déjà attaquées)
