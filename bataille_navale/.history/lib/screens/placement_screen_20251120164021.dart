...
class _PlacementScreenState extends State<PlacementScreen> {
  ...
  Future<void> _loadRecommendations() async {
    try {
      // Essayer de charger les recommandations si le service est disponible
      try {
        ...
        // Service d'analytics non disponible, continuer sans recommandations
        print('ℹ Service d\'analytics non disponible: $e');
      }
    } catch (e) {
