...
class _MainScreenState extends State<MainScreen> {
        ...
        builder: (context) => PlacementScreen(
          ...
          onPlacementComplete: (playerBoard) {
            try {
              ...
              // Le plateau de l'IA sera généré dans le GameScreen
              final game = Game(
                id: gameId,
                player1: player1,
                player2: player2,
              ...
              print('✓ Jeu vs IA créé: $gameId, board1 ships: ${playerBoard.ships.length}');

              Navigator.pop(context);
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => GameScreenV2(game: game),
                ),
              );
            } catch (e) {
  ...
  void _startLocalGame() {
    ...
    // Aller directement au placement screen pour joueur 1
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PlacementScreen(
          ...
          onPlacementComplete: (board1) {
            // Après placement joueur 1, aller au placement joueur 2
            Navigator.pop(context);
