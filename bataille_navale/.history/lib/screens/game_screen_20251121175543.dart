...
class _GameScreenState extends State<GameScreen> {
  ...
  void _playAIMove(GameService gameService) {
      ...
      try {
        ...
        print('Board opponent: ${currentGame.board1.ships.length} bateaux');      // Assurez-vous que ce coup n'a pas déjà été fait
      ...
      if (foundValidPosition) {
        ...
        print('Résultat: $result, nouveau tour: ${updatedGame.currentTurnPlayerId}');
